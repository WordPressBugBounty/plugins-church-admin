...
class vCard {
	...
	function setName( $family="", $first="", $additional="", $prefix="", $suffix="") {
		...
		if (!empty( $this->properties["FN"] )&&$this->properties["FN"]=="") $this->setFormattedName(trim("$prefix $first $additional $family $suffix") );
	}
	...
	// $type may be DOM | INTL | POSTAL | PARCEL | HOME | WORK or any combination of these: e.g. "WORK;PARCEL;POSTAL"
		...
		if (!empty( $this->properties["LABEL; $type;ENCODING=QUOTED-PRINTABLE"] )&&$this->properties["LABEL; $type;ENCODING=QUOTED-PRINTABLE"] == "") {
