...
if ( ! defined( 'ABSPATH' ) ) exit('You need Jesus!'); // Exit if accessed directly
    ...
    $church_admin_spiritual_gifts=array(
        1=>esc_html( __('Mercy','church-admin' ) ),
        2=>esc_html( __('Prophecy','church-admin' ) ),
        3=>esc_html( __('Administration','church-admin' ) ),
        4=>esc_html( __('Encouragement','church-admin' ) ),
        5=>esc_html( __('Counselling','church-admin' ) ),
        6=>esc_html( __('Evangelism','church-admin' ) ),
        7 =>esc_html( __('Giving','church-admin') ),
        8=> esc_html( __('Helps','church-admin') ),
        9=>esc_html( __('Intercession','church-admin') ) ,
        10=>esc_html( __('Hospitality','church-admin' ) ),
        11=>esc_html( __('Pastoring','church-admin') ),
        12=>esc_html( __('Teaching','church-admin' ) ),
        13 =>esc_html( __('Healing','church-admin' ) ),
        14 =>esc_html( __('Leadership','church-admin' ) ),
...
function church_admin_admin_init()  {
    ...
    $email_queue_count = $wpdb->get_var('SELECT COUNT(*) FROM '.$wpdb->prefix.'church_admin_email');
    $church_admin_menu=array(
        
        'people'=>array(
            'licence_level'=>array('free','basic','standard','premium'),
                    'module'=>'People',
                    'parent'=>'people',
                    'level'=>'Directory',
                    'section'=>'people',
        ...
        'people-map'=>array(
                    ...
                    'level'=>'Directory',
                    'section'=>'people',
                    'title'=>esc_html( __('People Map','church-admin' ) ),
                    'link'=>wp_nonce_url($church_admin_url.'&action=people-map&amp;section=people', 'people-map')
                ),
        ...
        'add-member-type'=>array(
                    ...
                    'link'=>wp_nonce_url($church_admin_url.'&action=add-member-type&amp;section=people','add-member-type')
                ),
        ...
        'automations'=>array(
            'licence_level'=>array('standard','premium'),
            'module'=>'Automations',
            'parent'=>'automations',
            'level'=>'Directory',
            'section'=>'automations',
            'title'=>esc_html( __('Automations','church-admin' ) ),
            'link'=>wp_nonce_url($church_admin_url.'&action=automations&amp;section=automations','automations'),
            "dashicon"=>'dashicons-id',
            "font-awesome"=>'<span class="ca-dashicons dashicons dashicons-superhero ca-dashicons"></span>',
            "background"=>"ca-darkgreen",
            "callback"=>'church_admin_automations_callback'
        ), 
        'new-user-email-template'=>array(
            'module'=>'Automations',
            'parent'=>'automations',
            'level'=>'Directory',
            'section'=>'automations',
            'title'=>esc_html( __('New user email template','church-admin' ) ),
            'link'=>wp_nonce_url($church_admin_url.'&action=new-user-email-template&amp;section=comms','new-user-email-template'),
        ),
        'key-dates'=>array(
            'licence_level'=>array('standard','premium'),
            'module'=>'Keydates',
            ...
            'level'=>'Directory',
            'section'=>'key-dates',
            'title'=>esc_html( __('Key dates','church-admin' ) ),
            'link'=>wp_nonce_url($church_admin_url.'&action=key-dates&amp;section=key-dates','key-dates'),
            "dashicon"=>'dashicons-id',
            "font-awesome"=>'<span class="ca-dashicons dashicons dashicons-admin-users ca-dashicons"></span>',
            "background"=>"ca-blue",
            "callback"=>'church_admin_keydates_callback'
        ),
        'birthdays'=>array(
            'module'=>'Keydates',
            'parent'=>'key-dates',
            ...
            'link'=>wp_nonce_url($church_admin_url.'&action=birthdays&amp;section=key-dates','birthdays'),
        ),
        'anniversaries'=>array(
            'module'=>'Keydates',
            'parent'=>'key-dates',
            'level'=>'Directory',
            'section'=>'key-dates',
            'title'=>esc_html( __('Wedding Anniversaries','church-admin' ) ),
            'link'=>wp_nonce_url($church_admin_url.'&action=anniversaries&amp;section=key-dates','anniversaries'),
        ),
        'happy-birthday-email-setup'=>array(
            'module'=>'Keydates',
            'parent'=>'key-dates',
            'level'=>'Directory',
            'section'=>'key-dates',
            'title'=>esc_html( __('Happy Birthday Email','church-admin' ) ),
            'link'=>wp_nonce_url($church_admin_url.'&action=happy-birthday-email-setup&amp;section=key-dates','happy-birthday-email-setup')
        ),
        'global-birthday-email-setup'=>array(
            'module'=>'Keydates',
            'parent'=>'key-dates',
            'level'=>'Directory',
            'section'=>'key-dates',
            'title'=>esc_html( __('Daily birthdays email','church-admin' ) ),
            'link'=>wp_nonce_url($church_admin_url.'&action=global-birthday-email-setup&amp;section=key-dates','global-birthday-email-setup'),
        ),
        'happy-anniversary-email-setup'=>array(
            'module'=>'Keydates',
            'parent'=>'key-dates',
            'level'=>'Directory',
            'section'=>'key-dates',
            'title'=>esc_html( __('Happy Anniversary Email','church-admin' ) ),
            'link'=>wp_nonce_url($church_admin_url.'&action=happy-anniversary-email-setup&amp;section=key-dates','happy-anniversary-email-setup')
        ),
        'global-anniversary-email-setup'=>array(
            'module'=>'Keydates',
            'parent'=>'key-dates',
            'level'=>'Directory',
            'section'=>'key-dates',
            'title'=>esc_html( __('Daily anniversaries email','church-admin' ) ),
            'link'=>wp_nonce_url($church_admin_url.'&action=global-anniversary-email-setup&amp;section=key-dates','global-anniversary-email-setup')
        ),
        'global-both-email-setup'=>array(
            'module'=>'Keydates',
            'parent'=>'key-dates',
            'level'=>'Directory',
            'section'=>'key-dates',
            'title'=>esc_html( __('Daily both email','church-admin' ) ),
            'link'=>wp_nonce_url($church_admin_url.'&action=global-both-email-setup&amp;section=key-dates','global-both-email-setup')
        ),
        'send-test-automation-emails'=>array(
            'module'=>'Keydates',
            'parent'=>'key-dates',
            'level'=>'Directory',
            'section'=>'key-dates',
            'title'=>esc_html( __('Send test email ','church-admin' ) ),
            'link'=>wp_nonce_url($church_admin_url.'&action=send-test-automation-emails&amp;section=key-dates','send-test-automation-emails'),
        ),
        ...
        'kiosk-app'=>array(
            ...
            'level'=>'Directory',
            'section'=>'kiosk-app',
            'title'=>esc_html( __('Kiosk App','church-admin' ) ),
            'link'=>wp_nonce_url($church_admin_url.'&action=kiosk-app&amp;section=kiosk-app','kiosk-app'),
            "dashicon"=>'dashicons-id',
            "font-awesome"=>'<span class="ca-dashicons dashicons dashicons-tablet ca-dashicons"></span>',
            "background"=>"ca-yellow",
            "callback"=>'church_admin_kiosk_app_callback'
        ),
        ...
        'contact-form'=>array(
            'licence_level'=>array('standard','premium'),
                    ...
                    'link'=>wp_nonce_url($church_admin_url.'&action=contact-form&amp;section=contact-form','contact-form'),
                    "dashicon"=>'dashicons-money-alt',
                    "font-awesome"=>'<span class="ca-dashicons dashicons dashicons-email ca-dashicons"></span>',
                    "background"=>"ca-blue",
        ...
        'contact-form-settings'=>array(
                    ...
                    'level'=>'Directory',
                    'section'=>'contact-form',
                    'title'=>esc_html( __('Contact form settings','church-admin' ) ),
                    'link'=>wp_nonce_url($church_admin_url.'&action=contact-form-settings&amp;section=contact-form' , 'contact-form-settings')
                ), 
        'giving'=>array(
            'licence_level'=>array('standard','premium'),
                    'module'=>'Giving',
                    ...
                    'link'=>wp_nonce_url($church_admin_url.'&action=giving&amp;section=giving','giving'),
                    "dashicon"=>'dashicons-email',
                    "font-awesome"=>'<span class="ca-dashicons dashicons dashicons-money-alt ca-dashicons"></span>',
        ...
        'edit-gift'=>array(
                    ...
                    'level'=>'Giving',
                    'section'=>'giving',
                    'title'=>esc_html( __('Add gift','church-admin' ) ),
                    'link'=>wp_nonce_url($church_admin_url.'&action=edit-gift&amp;section=giving','edit-gift')
                ),
        'funds'=>array(
                    'module'=>'Giving',
                    'parent'=>'giving',
                    'level'=>'Giving',
                    'section'=>'giving',
                    'title'=>esc_html( __('Funds','church-admin' ) ),
        ...
        'edit-fund'=>array(
                    ...
                    'level'=>'Giving',
                    'section'=>'giving',
                    'title'=>esc_html( __('Add fund','church-admin' ) ),
                    'link'=>wp_nonce_url($church_admin_url.'&action=edit-fund&amp;section=giving','edit-fund')
                ),
        'giving-csv'=>array(
                    'module'=>'Giving',
                    'parent'=>'giving',
                    'level'=>'Giving',
                    'section'=>'giving',
                    'title'=>esc_html( __('Giving CSV','church-admin' ) ),
                    'link'=>wp_nonce_url($church_admin_url.'&action=giving-csv&amp;section=giving','giving-csv')
                ),
        'gift-aid-csv'=>array(
                    'module'=>'Giving',
                    'parent'=>'giving',
                    'level'=>'Giving',
                    'section'=>'giving',
                    'title'=>esc_html( __('Gift Aid report CSV','church-admin' ) ),
                    'link'=>wp_nonce_url($church_admin_url.'&action=gift-aid-csv&amp;section=giving','gift-aid-csv')
                ),
        'payment-gateway-setup'=>array(
                    'module'=>'Giving',
                    'parent'=>'giving',
                    'level'=>'Giving',
                    'section'=>'giving',
                    'title'=>esc_html( __('Payment Gateway Setup','church-admin' ) ),
                    'link'=>wp_nonce_url($church_admin_url.'&action=payment-gateway-setup&amp;section=settings','payment-gateway-setup')
                ), 
        'pledges'=>array(
                    'module'=>'Giving',
                    'parent'=>'giving',
                    ...
                    'link'=>wp_nonce_url( $church_admin_url.'&action=pledges-list&amp;section=giving','pledges')
                ),
        'edit-pledge'=>array(
                    'module'=>'Giving',
                    'parent'=>'giving',
                    'level'=>'Giving',
                    'section'=>'giving',
                    'title'=>esc_html( __('Add pledge','church-admin' ) ),
                    'link'=>wp_nonce_url( $church_admin_url.'&action=edit-pledge&amp;section=giving','edit-pledge')
                ),
        
        'donation-receipt-template'=>array(
            'module'=>'Giving',
            'parent'=>'giving',
            'level'=>'Giving',
            'section'=>'giving',
            'title'=>esc_html( __('Donation receipt template','church-admin' ) ),
            'link'=>wp_nonce_url($church_admin_url.'&action=donation-receipt-template&amp;section=giving','donation-receipt-template')
        ),
        'child-protection'=>array(
            'licence_level'=>array('premium'),
            'module'=>'ChildProtection',
            'parent'=>'child-protection',
            'level'=>'ChildProtection',
            'section'=>'child-protection',
            'title'=>esc_html( __('Child Protection Incidents','church-admin' ) ),
            'link'=>wp_nonce_url($church_admin_url.'&action=child-protection&amp;section=child-protection-reporting','child-protection'),
            "dashicon"=>'dashicons-admin-users',
            "font-awesome"=>'<span class="ca-dashicons dashicons dashicons-warning ca-dashicons"></span>',
            "background"=>"ca-red",
            "callback"=>'church_admin_child_protection_callback'
        ),
        'childrens-work'=>array(
                    ...
                    'title'=>esc_html( __('Age Related Groups','church-admin' ) ),
                    'link'=>wp_nonce_url($church_admin_url.'&action=childrens-work&amp;section=childrens-work','childrens-work'),
                    "dashicon"=>'dashicons-admin-users',
                    "font-awesome"=>'<span class="ca-dashicons dashicons dashicons-universal-access ca-dashicons"></span>',
                    "background"=>"ca-blue",
        ...
        'kidswork-pdf'=>array(
                    ...
                    'level'=>'Kidswork',
                    'section'=>'childrens-work',
                    'title'=>esc_html( __('Childrens groups PDF','church-admin' ) ),
                    'link'=>wp_nonce_url($church_admin_url.'&action=kidswork-pdf&amp;section=childrens-work','kidswork-pdf')
                ),
        'kidswork-checkin-pdf'=>array(
                    ...
                    'level'=>'Kidswork',
                    'section'=>'childrens-work',
                    'title'=>esc_html( __('Childrens checkin PDF','church-admin' ) ),
                    'link'=>wp_nonce_url($church_admin_url.'&action=kidswork-checkin-pdf&amp;section=childrens-work','kidswork-checkin-pdf')
                ), 
        ...
        'safeguarding'=>array(
            ...
            'level'=>'Kidswork',
            'section'=>'childrens-work',
            'title'=>esc_html( __('Safeguarding','church-admin' ) ),
            'link'=>wp_nonce_url($church_admin_url.'&action=safeguarding&amp;section=childrens-work','safeguarding')
        ),
        'legacy-safeguarding'=>array(
                    'module'=>'Children',
                    'parent'=>'childrens-work',
                    'level'=>'Kidswork',
                    'section'=>'childrens-work',
                    'title'=>esc_html( __('Legacy Safeguarding','church-admin' ) ),
                    'link'=>wp_nonce_url($church_admin_url.'&action=legacy-safeguarding&amp;section=childrens-work','legacy-safeguarding')
                ),
        'classes'=>array(
                    'licence_level'=>array('standard','premium'),
                    'module'=>'Classes',
                    ...
                    'level'=>'Kidswork',
                    'section'=>'classes',
                    'title'=>esc_html( __('Classes','church-admin' ) ),
                    'link'=>wp_nonce_url($church_admin_url.'&action=classes&amp;section=classes','classes'),
                    "dashicon"=>'dashicons-awards',
                    "font-awesome"=>'<span class="ca-dashicons dashicons dashicons-groups ca-dashicons"></span>',
        ...
        'edit-class'=>array(
                    ...
                    'level'=>'Kidswork',
                    'section'=>'classes',
                    'title'=>esc_html( __('Add a class','church-admin' ) ),
                    'link'=>wp_nonce_url($church_admin_url.'&action=edit-class&amp;section=classes','edit-class')
                ),
        'events'=>array( 'licence_level'=>array('standard','premium'),
                    'module'=>'Events',
                    'parent'=>'events',
                    'level'=>'Events',
                    'section'=>'events',
                    'title'=>esc_html( __('Events','church-admin' ) ),
                    'link'=>wp_nonce_url($church_admin_url.'&action=events&amp;section=events','events'),
                    "dashicon"=>'dashicons-tickets-alt',
                    "font-awesome"=>'<span class="ca-dashicons dashicons dashicons-tickets-alt ca-dashicons"></span>',
                    "background"=>"ca-red",
        ...
        'add-event'=>array(
                    ...
                    'level'=>'Events',
                    'section'=>'events',
                    'title'=>esc_html( __('Add an event','church-admin' ) ),
                    'link'=>wp_nonce_url($church_admin_url.'&action=edit-event&amp;section=events','edit-event')
                ),
        'attendance'=>array(
            'licence_level'=>array('standard','premium'),
                    'module'=>'Attendance',
                    ...
                    'link'=>wp_nonce_url($church_admin_url.'&action=attendance&amp;section=attendance','attendance'),
                    "dashicon"=>'dashicons-editor-ol',
                    "font-awesome"=>'<span class="ca-dashicons dashicons dashicons-chart-line ca-dashicons"></span>',
        ...
        'weeks-attendance'=>array(
            ...
            'link'=>wp_nonce_url($church_admin_url.'&action=weeks-attendance&amp;section=attendance','weeks-attendance')
        ),
        'add-attendance'=>array(
                    ...
                    'level'=>'Attendance',
                    'section'=>'attendance',
                    'title'=>esc_html( __('Add attendance','church-admin' ) ),
                    'link'=>wp_nonce_url($church_admin_url.'&action=add-attendance&amp;section=attendance','edit-attendance')
                ),
        'individual-attendance-list'=>array(
            ...
            'level'=>'Attendance',
            'section'=>'attendance',
            'title'=>esc_html( __('Show individual attendance dates','church-admin' ) ),
            'link'=>wp_nonce_url($church_admin_url.'&action=individual-attendance-list&amp;section=attendance','individual-attendance-list')
        ),
        'individual-attendance'=>array(
                    ...
                    'level'=>'Attendance',
                    'section'=>'attendance',
                    'title'=>esc_html( __('Add individual attendance','church-admin' ) ),
                    'link'=>wp_nonce_url($church_admin_url.'&action=individual-attendance&amp;section=attendance','individual-attendance')
                ),
        'individual-attendance-csv'=>array(
                    ...
                    'level'=>'Attendance',
                    'section'=>'attendance',
                    'title'=>esc_html( __('Individual attendance CSV','church-admin' ) ),
                    'link'=>wp_nonce_url($church_admin_url.'&action=individual-attendance-csv&amp;section=attendance','individual-attendance-csv')
                ),  
        'follow-up'=>array(
            'licence_level'=>array('standard','premium'),
                    'module'=>'Attendance',
                    ...
                    'level'=>'Attendance',
                    'section'=>'follow-up',
                    'title'=>esc_html( __('Follow up','church-admin' ) ),
                    'link'=>wp_nonce_url($church_admin_url.'&action=funnel&amp;section=follow-up','funnel'),
                    "dashicon"=>'dashicons-editor-ol',
                    "font-awesome"=>'<span class="ca-dashicons dashicons dashicons-update ca-dashicons"></span>',
                    "background"=>"ca-gold",
        ...
        'add-funnel'=>array(
                    ...
                    'level'=>'Attendance',
                    'section'=>'follow-up',
                    'title'=>esc_html( __('Add funnel','church-admin' ) ),
                    'link'=>wp_nonce_url($church_admin_url.'&action=add-funnel&amp;section=follow-up','add-funnel')
                ),
        'units'=>array(
            'licence_level'=>array('standard','premium'),
                    'module'=>'Units',
                    ...
                    'level'=>'Units',
                    'section'=>'units',
                    'title'=>esc_html( __('Units','church-admin' ) ),
                    'link'=>wp_nonce_url($church_admin_url.'&action=units&amp;section=units','units'),
                    "dashicon"=>'dashicons-networking',
                    "font-awesome"=>'<span class="ca-dashicons dashicons dashicons-networking ca-dashicons"></span>',
                    "background"=>"ca-gray",
        ...
        'add-unit'=>array(
                    ...
                    'level'=>'Units',
                    'section'=>'units',
                    'title'=>esc_html( __('Add unit','church-admin' ) ),
                    'link'=>wp_nonce_url($church_admin_url.'&action=add-unit&amp;section=units','add-unit'),
                    "dashicon"=>'dashicons-networking'
                ),
        'spiritual-gifts'=>array(
                    ...
                    'link'=>wp_nonce_url($church_admin_url.'&action=spiritual-gifts&amp;section=spiritual-gifts','spiritual-gifts'),
                    "font-awesome"=>'<span class="ca-dashicons dashicons dashicons-buddicons-community ca-dashicons"></span>',
                    "background"=>"ca-yellow",
        ...
        'groups'=>array(
            'licence_level'=>array('standard','premium'),
                    ...
                    'level'=>'Small Groups',
                    'section'=>'groups',
                    'title'=>esc_html( __('Small groups','church-admin' ) ),
                    'link'=>wp_nonce_url($church_admin_url.'&action=groups&amp;section=groups','groups'),
                    "dashicon"=>'dashicons-networking',
                    "font-awesome"=>'<span class="ca-dashicons dashicons dashicons-groups ca-dashicons"></span>',
        ...
        'smallgroup-structure'=>array(
                    ...
                    'level'=>'Small Groups',
                    'section'=>'groups',
                    'title'=>esc_html( __('Small group structure','church-admin' ) ),
                    'link'=>wp_nonce_url($church_admin_url.'&action=small-group-structure&amp;section=groups','smallgroup-structure')
                ),
        'smallgroup-metrics'=>array(
                    ...
                    'level'=>'Small Groups',
                    'section'=>'groups',
                    'title'=>esc_html( __('Small group metrics','church-admin' ) ),
                    'link'=>wp_nonce_url($church_admin_url.'&action=small-group-metrics&amp;section=groups','smallgroup-metrics')
                ),
        'smallgroup-show-pdf-form'=>array(
            ...
            'level'=>'Small Groups',
            'section'=>'groups',
            'title'=>esc_html( __('Small group PDF form','church-admin' ) ),
            'link'=>wp_nonce_url($church_admin_url.'&action=smallgroup-show-pdf-form&amp;section=groups','smallgroup-show-pdf-form')
        ),        
        'oversight-list'=>array(
                    ...
                    'level'=>'Small Groups',
                    'section'=>'groups',
                    'title'=>esc_html( __('Oversight list','church-admin' ) ),
                    'link'=>wp_nonce_url($church_admin_url.'&action=oversight-list&amp;section=groups','oversight-list')
                ),
        'smallgroups-map'=>array(
                    ...
                    'level'=>'Small Groups',
                    'section'=>'groups',
                    'title'=>esc_html( __('Smallgroups map','church-admin' ) ),
                    'link'=>wp_nonce_url($church_admin_url.'&action=smallgroups-map&amp;section=groups','smallgroups-map')
                ),
        'edit-group'=>array(
                    'module'=>'Groups',
                    'parent'=>'groups',
                    'level'=>'Small Groups',
                    'section'=>'groups',
                    'title'=>esc_html( __('Add a group','church-admin' ) ),
                    'link'=>wp_nonce_url($church_admin_url.'&action=edit-group&amp;section=groups','edit-small-group')
                ),
        'show-groups'=>array(
                    'module'=>'Groups',
                    'parent'=>'groups',
                    'level'=>'Small Groups',
                    'section'=>'groups',
                    'title'=>esc_html( __('Show groups','church-admin' ) ),
                    'link'=>wp_nonce_url($church_admin_url.'&action=show-groups&amp;section=groups','show-groups')
                ),
        'cleanup-groups'=>array(
                    ...
                    'level'=>'Small Groups',
                    'section'=>'groups',
                    'title'=>esc_html( __('Cleanup groups','church-admin' ) ),
                    'link'=>wp_nonce_url($church_admin_url.'&action=cleanup-groups&amp;section=groups','cleanup-groups')
                ),
            'delete-groups'=>array(
                    'module'=>'Groups',
                    'parent'=>'groups',
                    ...
                    'level'=>'Small Groups',
                    'section'=>'groups',
                    'title'=>esc_html( __('Delete all groups','church-admin' ) ),
                    'link'=>wp_nonce_url($church_admin_url.'&action=delete-all-groups&amp;section=groups','delete-groups')
                ),
                'unattached'=>array(
                    'module'=>'Groups',
                    'parent'=>'groups',
                    'level'=>'Small Groups',
                    'section'=>'groups',
                    'title'=>esc_html( __('Unattached to group list','church-admin' ) ),
                    'link'=>wp_nonce_url($church_admin_url.'&action=unattached&amp;section=groups', 'unattached')
                ),
            'services'=>array(
                    'licence_level'=>array('standard','premium'),
                    'module'=>'Services',
                    ...
                    'level'=>'Service',
                    'section'=>'services',
                    'title'=>esc_html( __('Sites & Services','church-admin' ) ),
                    'link'=>wp_nonce_url($church_admin_url.'&action=services-list&amp;section=services','services-list'),
                    "dashicon"=>'dashicons-groups',
                    "font-awesome"=>'<span class="ca-dashicons dashicons dashicons-location-alt ca-dashicons"></span>',
                    "background"=>"ca-brown",
            ...
            'add-service'=>array(
                    ...
                    'level'=>'Service',
                    'section'=>'services',
                    'title'=>esc_html( __('Add service','church-admin' ) ),
                    'link'=>wp_nonce_url($church_admin_url.'&action=edit-service&amp;section=services', 'edit-service')
                ),
            'service-prebooking'=>array(
                    ...
                    'level'=>'Service',
                    'section'=>'services',
                    'title'=>esc_html( __('Service pre-bookings','church-admin' ) ),
                    'link'=>wp_nonce_url($church_admin_url.'&action=service-prebooking&amp;section=services','service-prebooking')
                ),
            'sites'=>array(
                    'module'=>'Services',
                    'parent'=>'services',
                    'level'=>'Service',
                    'section'=>'services',
                    'title'=>esc_html( __('Sites','church-admin' ) ),
                    'link'=>wp_nonce_url($church_admin_url.'&action=site-list&amp;section=services','site-list')
                ),
            'edit-site'=>array(
                    'module'=>'Services',
                    'parent'=>'services',
                    'level'=>'Service',
                    'section'=>'services',
                    'title'=>esc_html( __('Add site','church-admin' ) ),
                    'link'=>wp_nonce_url($church_admin_url.'&action=edit-site&amp;section=edit-site','edit-site')
                ),
            
        'comms'=>array('licence_level'=>array('standard','premium'),
                    'module'=>'Comms',
                    'parent'=>'comms',
                    'level'=>'Bulk_Email',
                    'section'=>'comms',
                    'title'=>esc_html( __('Communications','church-admin' ) ),
                    'link'=>wp_nonce_url($church_admin_url.'&action=comms&amp;section=comms','comms'),
        ...
        'push-message'=>array(
                    ...
                    'link'=>wp_nonce_url($church_admin_url.'&action=push&amp;section=comms','push')
                ),
        ...
        'sms-settings'=>array(
                    ...
                    'level'=>'Bulk_SMS',
                    'section'=>'comms',
                    'title'=>esc_html( __('SMS settings','church-admin' ) ),
                    'link'=>wp_nonce_url($church_admin_url.'&action=sms-settings&amp;section=comms','sms-settings')
                ),
        'send-sms'=>array(
                    'module'=>'Comms',
                    'parent'=>'comms',
                    'level'=>'Bulk_SMS',
                    'section'=>'comms',
                    'title'=>esc_html( __('Send SMS','church-admin' ) ),
                    'link'=>wp_nonce_url($church_admin_url.'&action=send-sms&amp;section=comms','send-sms')
                ),
        'twilio-replies'=>array(
                    ...
                    'level'=>'Bulk_SMS',
                    'section'=>'comms',
                    'title'=>esc_html( __('SMS Replies','church-admin' ) ),
                    'link'=>wp_nonce_url($church_admin_url.'&action=twilio-replies&amp;section=comms','twilio-replies')
                ),
        ...
        'smtp-settings'=>array(
                    ...
                    'level'=>'Bulk_Email',
                    'section'=>'comms',
                    'title'=>esc_html( __('SMTP settings','church-admin' ) ),
                    'link'=>wp_nonce_url($church_admin_url.'&action=smtp-settings&amp;section=comms','smtp-settings')
                ),
        ...
        'clear-email-queue'=>array(
            'module'=>'Comms',
            'parent'=>'comms',
            'level'=>'Bulk_Email',
            'section'=>'comms',
            'title'=>esc_html(sprintf( __('Empty email queue (%1$s)','church-admin' ), $email_queue_count)),
            'link'=>wp_nonce_url($church_admin_url.'&action=clear-email-queue&amp;section=comms','clear-email-queue')
        ),
        'email-settings'=>array(
                    'module'=>'Comms',
                    'parent'=>'comms',
        ...
        'rota'=>array('licence_level'=>array('standard','premium'),
                    'module'=>'Rota',
                    'parent'=>'rota',
                    'level'=>'Rota',
                    'section'=>'rota',
                    'title'=>esc_html( __('Schedule','church-admin' ) ),
                    'link'=>wp_nonce_url($church_admin_url.'&action=rota&amp;section=rota','rota'),
                    "dashicon"=>'dashicons-editor-ol',
                    "font-awesome"=>'<span class="ca-dashicons dashicons dashicons-clipboard ca-dashicons"></span>',
                    "background"=>"ca-yellow",
        ...
        'not-available'=>array(
            ...
            'level'=>'Rota',
            'section'=>'rota',
            'title'=>esc_html( __('Non availability','church-admin' ) ),
            'link'=>wp_nonce_url($church_admin_url.'&action=not-available&amp;section=rota','not-available')
        ),
        'rota-settings'=>array(
                    'module'=>'Rota',
                    'parent'=>'rota',
                    'level'=>'Rota',
                    'section'=>'rota',
                    'title'=>esc_html( __('Schedule jobs','church-admin' ) ),
                    'link'=>wp_nonce_url($church_admin_url.'&action=rota-settings&amp;section=rota','rota-settings')
                ),
        'edit-rota-job'=>array(
                    'module'=>'Rota',
                    'parent'=>'rota',
                    'level'=>'Rota',
                    'section'=>'rota',
                    'title'=>esc_html( __('Add a schedule job','church-admin' ) ),
                    'link'=>wp_nonce_url($church_admin_url.'&action=edit-rota-job&amp;section=rota','edit-rota-job')
                ),
        'auto-email-rota'=>array(
                    ...
                    'level'=>'Rota',
                    'section'=>'rota',
                    'title'=>esc_html( __('Auto email schedule','church-admin' ) ),
                    'link'=>wp_nonce_url($church_admin_url.'&action=auto-email-rota&amp;section=rota','auto-email-rota')
                ),
        'auto-sms-rota'=>array(
                    'module'=>'Rota',
                    'parent'=>'rota',
                    'level'=>'Rota',
                    'section'=>'rota',
                    'title'=>esc_html( __('Auto SMS schedule','church-admin' ) ),
                    'link'=>wp_nonce_url($church_admin_url.'&action=auto-sms-rota&amp;section=rota','auto-sms-rota')
                ),
        'show-cron'=>array(
                    'module'=>'Rota',
                    'parent'=>'rota',
                    'level'=>'Rota',
                    'section'=>'rota',
                    'title'=>esc_html( __('Show schedule cron jobs','church-admin' ) ),
                    'link'=>wp_nonce_url($church_admin_url.'&action=show-cron&amp;section=rota','show-cron')
                ),
        'email-rota'=>array(
                    'module'=>'Rota',
                    'parent'=>'rota',
                    'level'=>'Rota',
                    'section'=>'rota',
                    'title'=>esc_html( __('Email schedule','church-admin' ) ),
                    'link'=>wp_nonce_url($church_admin_url.'&action=email-rota&amp;section=rota','email-rota')
                ),
        'sms-rota'=>array(
                    'module'=>'Rota',
                    'parent'=>'rota',
                    'level'=>'Rota',
                    'section'=>'rota',
                    'title'=>esc_html( __('SMS schedule','church-admin' ) ),
                    'link'=>wp_nonce_url($church_admin_url.'&action=sms-rota&amp;section=rota','sms-rota')
                ),
        'pdf-rota'=>array(
                    'module'=>'Rota',
                    'parent'=>'rota',
                    'level'=>'Rota',
                    'section'=>'rota',
                    'title'=>esc_html( __('PDF schedule','church-admin' ) ),
                    'link'=>wp_nonce_url($church_admin_url.'&action=pdf-rota&amp;section=rota','pdf-rota')
                ),
        'csv-rota'=>array(
                    'module'=>'Rota',
                    'parent'=>'rota',
                    'level'=>'Rota',
                    'section'=>'rota',
                    'title'=>esc_html( __('CSV schedule','church-admin' ) ),
                    'link'=>wp_nonce_url($church_admin_url.'&action=csv-rota&amp;section=rota','csv-rota')
                ),
        'calendar'=>array(
        ...
        'edit-category'=>array(
            ...
            'facilities'=>array('licence_level'=>array('standard','premium'),
                    'module'=>'Facilities',
                    'parent'=>'facilities',
                    'level'=>'Facilities',
                    'section'=>'facilities',
                    'title'=>esc_html( __('Facilities','church-admin' ) ),
                    'link'=>wp_nonce_url($church_admin_url.'&action=facilities&amp;section=facilities','facilities'),
                    "dashicon"=>'dashicons-calendar-alt',
                    "font-awesome"=>'<span class="ca-dashicons dashicons dashicons-layout ca-dashicons"></span>',
                    "background"=>"ca-grape",
            ...
            'facility-bookings'=>array(
                    ...
                    'level'=>'Facilities',
                    'section'=>'facilities',
                    'title'=>esc_html( __('Facility bookings','church-admin' ) ),
                    'link'=>wp_nonce_url($church_admin_url.'&action=facility-bookings&amp;section=facilities','facility-bookings')
                ),
        'ministries'=>array('licence_level'=>array('standard','premium'),
                    'module'=>'Ministries',
                    'parent'=>'ministries',
                    'level'=>'Ministries',
                    'section'=>'ministries',
                    'title'=>esc_html( __('Ministries','church-admin' ) ),
                    'link'=>wp_nonce_url($church_admin_url.'&action=ministries&amp;section=ministries','ministries'),
                    "dashicon"=>'dashicons-networking',
                    "font-awesome"=>'<span class="ca-dashicons dashicons dashicons-admin-tools ca-dashicons"></span>',
                    "background"=>"ca-cyan",
        ...
        'edit-ministry'=>array(
                    ...
                    'level'=>'Ministries',
                    'section'=>'ministries',
                    'title'=>esc_html( __('Add a ministry','church-admin' ) ),
                    'link'=>wp_nonce_url($church_admin_url.'&action=edit-ministry&amp;section=ministries','edit-ministry')
                ),
        'volunteers'=>array(
                    'module'=>'Ministries',
                    'parent'=>'ministries',
                    'level'=>'Ministries',
                    'section'=>'ministries',
                    'title'=>esc_html( __('Volunteers','church-admin' ) ),
                    'link'=>wp_nonce_url($church_admin_url.'&action=volunteers&amp;section=ministries','volunteers')
                ),
        'media'=>array(
            'licence_level'=>array('basic','standard','premium'),
                    'module'=>'Media',
                    'parent'=>'media',
                    'level'=>'Sermons',
                    'section'=>'media',
        ...
        'import-podcast'=>array(
                    'module'=>'Media',
                    'parent'=>'media',
                    'level'=>'Sermons',
                    'section'=>'media',
                    'title'=>esc_html( __('Import podcast','church-admin' ) ),
                    'link'=>wp_nonce_url($church_admin_url.'&action=itunes-importer&amp;section=media','itunes-importer')
                ),     
        'app'=>array('licence_level'=>array('premium'),
                    'module'=>'App',
                    'parent'=>'app',
                    'level'=>'Directory',
                    'section'=>'app',
                    'title'=>esc_html( __('App','church-admin' ) ),
                    'link'=>wp_nonce_url($church_admin_url.'&action=app&amp;section=app','app'),
         ...
         'app-menu'=>array(
                    ...
                    'level'=>'Directory',
                    'section'=>'app',
                    'title'=>esc_html( __('App menu','church-admin' ) ),
                    'link'=>wp_nonce_url($church_admin_url.'&action=app-menu&amp;section=app','app-menu')
                ), 
        'app-settings'=>array(
                    'module'=>'App',
                    'parent'=>'app',
                    'level'=>'Directory',
                    'section'=>'app',
                    'title'=>esc_html( __('App settings','church-admin' ) ),
                    'link'=>wp_nonce_url($church_admin_url.'&action=app-settings&amp;section=app','app-settings')
                ), 
        'app-users'=>array(
                    'module'=>'App',
                    'parent'=>'app',
                    'level'=>'Directory',
                    'section'=>'app',
                    'title'=>esc_html( __('App users','church-admin' ) ),
                    'link'=>wp_nonce_url($church_admin_url.'&action=app-logins&amp;section=app','app-users')
                ),
        ...
        'app-visits'=>array(
                    ...
                    'level'=>'Directory',
                    'section'=>'app',
                    'title'=>esc_html( __('App page views','church-admin' ) ),
                    'link'=>wp_nonce_url($church_admin_url.'&action=app-visits&amp;section=app','app-visits')
                ),
        'app-settings'=>array(
                    'module'=>'App',
                    'parent'=>'app',
        ...
        'push'=>array(
                    ...
                    'section'=>'app',
                    'title'=>esc_html( __('Push message','church-admin' ) ),
                    'link'=>wp_nonce_url($church_admin_url.'&action=push&amp;section=app','push')
                ),
        'app-logout'=>array(
                    'module'=>'App',
                    'confirm'=>TRUE,
                    ...
                    'level'=>'Directory',
                    'section'=>'app',
                    'title'=>esc_html( __('Logout everyone','church-admin' ) ),
                    'link'=>wp_nonce_url($church_admin_url.'&action=app-settings&amp;section=app','app-logout'),
                ),
        'bible-version'=>array(
                    'module'=>'App',
                    'parent'=>'app',
                    'level'=>'Directory',
                    'section'=>'app',
                    'title'=>esc_html( __('Bible version','church-admin' ) ),
                    'link'=>wp_nonce_url($church_admin_url.'&action=bible-version&amp;section=app','bible-version'),
                ),
        'bible-reading-plan'=>array(
                    ...
                    'level'=>'Directory',
                    'section'=>'app',
                    'title'=>esc_html( __('Bible reading plan','church-admin' ) ),
                    'link'=>wp_nonce_url($church_admin_url.'&action=bible-reading-plan&amp;section=app','bible-reading-plan')
                ),
        'churchwide-my-prayer'=>array(
                    ...
                    'level'=>'Directory',
                    'section'=>'app',
                    'title'=>esc_html( __('Churchwide prayer','church-admin' ) ),
                    'link'=>wp_nonce_url($church_admin_url.'&action=churchwide-my-prayer&amp;section=app','churchwide-my-prayer')
                ),
        'sessions'=>array(
            'licence_level'=>array('standard','premium'),
            'module'=>'Sessions',
            ...
            'link'=>wp_nonce_url($church_admin_url.'&action=sessions&amp;section=sessions','sessions'),
            "dashicon"=>'dashicons-groups',
            "font-awesome"=>'<span class="ca-dashicons dashicons dashicons-groups ca-dashicons"></span>',
            "background"=>"ca-teal",
        ...
        'inventory'=>array(
            ...
            'level'=>'Inventory',
            'section'=>'inventory',
            'title'=>esc_html( __('Inventory','church-admin' ) ),
            'link'=>wp_nonce_url($church_admin_url.'&action=inventory&amp;section=inventory','inventory'),
            "dashicon"=>'dashicons-admin-generic',
            "font-awesome"=>'<span class="ca-dashicons dashicons dashicons-editor-ol ca-dashicons"></span>',
            "background"=>"ca-yellow",
        ...
        'pastoral'=>array(
            ...
            'module'=>'Pastoral',
                    ...
                    'level'=>'Pastoral',
                    'section'=>'pastoral',
                    'title'=>esc_html( __('Pastoral','church-admin' ) ),
                    'link'=>wp_nonce_url($church_admin_url.'&action=pastoral&amp;section=pastoral','pastoral'),
                    "dashicon"=>'dashicons-admin-generic',
                    "font-awesome"=>'<span class="ca-dashicons dashicons dashicons-heart ca-dashicons"></span>',
                    "background"=>"ca-red",
                    "callback"=>'church_admin_pastoral_callback'
        ),
        'pastoral-visit-list'=>array(
            'module'=>'Pastoral',
                    'parent'=>'pastoral',
                    'level'=>'Pastoral',
                    'section'=>'pastoral',
                    'title'=>esc_html( __('Pastoral visit list','church-admin' ) ),
                    'link'=>wp_nonce_url($church_admin_url.'&action=pastoral-visit-list','pastoral-visit-list')
        ),
        'pastoral-settings'=>array(
            'module'=>'Pastoral',
                    'parent'=>'pastoral',
                    'level'=>'Pastoral',
                    'section'=>'pastoral',
                    'title'=>esc_html( __('Pastoral settings','church-admin' ) ),
                    'link'=>wp_nonce_url($church_admin_url.'&action=pastoral-settings&amp;section=pastoral','pastoral-settings')
        ),
        'settings'=>array(
            'licence_level'=>array('free','basic','standard','premium'),
                    'module'=>'Settings',
        ...
        'global-communications-settings'=>array(
                    ...
                    'level'=>'Directory',
                    'section'=>'settings',
                    'title'=>esc_html( __('Global Communications settings','church-admin' ) ),
                    'link'=>wp_nonce_url($church_admin_url.'&action=global-communications-settings&amp;section=global-communications-settings','global-communications-settings')
                ),
        'registration-email-settings'=>array(
                    'module'=>'Settings',
                    'parent'=>'settings',
                    'level'=>'Directory',
                    'section'=>'settings',
                    'title'=>esc_html( __('Registration email settings','church-admin' ) ),
                    'link'=>wp_nonce_url($church_admin_url.'&action=registration-email-settings&amp;section=registration-followup-email-setup','registration-email-settings')
                ),
        ...
        'bulk-bible-readings'=>array(
            ...
            'level'=>'Bible',
            'section'=>'settings',
            'title'=>esc_html( __('Bulk Bible reading publish','church-admin' ) ),
            'link'=>wp_nonce_url($church_admin_url.'&action=bulk-bible-readings&amp;section=settings','bulk-bible-readings')
        ),        
        'choose-modules'=>array(
                    ...
                    'level'=>'Directory',
                    'section'=>'settings',
                    'title'=>esc_html( __('Choose modules','church-admin' ) ),
                    'link'=>wp_nonce_url($church_admin_url.'&action=choose-modules&amp;section=settings','choose-modules')
                ),
        'choose-filters'=>array(
                    ...
                    'level'=>'Directory',
                    'section'=>'settings',
                    'title'=>esc_html( __('Choose filters','church-admin' ) ),
                    'link'=>wp_nonce_url($church_admin_url.'&action=choose-filters&amp;section=settings','choose-filters')
                ),
        ...
        'qrcode-generator'=>array(
                    ...
                    'level'=>'Directory',
                    'section'=>'settings',
                    'title'=>esc_html( __('QR code generator','church-admin' ) ),
                    'link'=>wp_nonce_url($church_admin_url.'&action=qrcode-generator&amp;section=settings','qrcode-generator')
                ),
        'roles'=>array(
                    'module'=>'Settings',
                    'parent'=>'settings',
...
function church_admin_initialise() {
	global $church_admin_url,$level,$church_admin_version,$wpdb,$current_user,$church_admin_prayer_request_success,$member_types,$ministries;
    ...
    if(!empty($_GET['licence-change'])&&$_GET['licence-change']=='reset'){
        ...
        echo'<p>Church Admin version: '.esc_html($church_admin_version).'</p>';
    ...
    if(!empty( $_GET['confirm_email'] )&&!empty( $_GET['people_id'] ) )
	{
        ...
        if(!empty($validated))
        {
            ...
            if(!empty( $person) )
            {
                ...
                {
                    /*
                    $adminmessage='<p>'.sprintf(esc_html(__('A new household has confirmed their email. Please %1$s check them %2$s out and give user account if happy.','church-admin' ) ),'<a href="'.wp_nonce_url(esc_url(site_url().'/wp-admin/admin.php?page=church_admin/index.php&action=display-household&household_id='.(int)$person->household_id.'&section=people'),'display-household').'">','</a>').'</p>';
                    */
...
function church_admin_register_frontend_scripts() {
	...
	//( 'jquery-ui-datepicker',plugins_url('/', __FILE__) . 'includes/jquery-ui.min.js',array('jquery'),NULL );
...
function church_admin_register( $atts, $content = null)
{
    ...
    wp_enqueue_script('ca-draganddrop');
    wp_enqueue_script('jquery-ui-datepicker');
    wp_enqueue_style('church-admin-ui-css','https://ajax.googleapis.com/ajax/libs/jqueryui/1.13.2/themes/smoothness/jquery-ui.css',false,$church_admin_version,false);
...
function church_admin_auto_sms_rota($service_id)
{
    ...
    //church_admin_debug('Firing auto sms');
		...
		//Change the SQL to look for DISTINCT dates in the next 1 week and then send rotas for all the dates
        //church_admin_debug("Look for services...");
		$rota_date=$wpdb->get_row('SELECT rota_date, service_time FROM  '.$wpdb->prefix.'church_admin_new_rota WHERE mtg_type="service" AND  service_id="'.(int)$service_id.'"  AND rota_date BETWEEN CURDATE() AND date_add(CURDATE(), INTERVAL 1 WEEK) ORDER BY service_id,rota_date ASC LIMIT 1');
        //church_admin_debug $wpdb->last_query);
        ...
        foreach( $rotaJobs AS $rota_task_id=>$jobName)
        {
                ...
                if(!empty( $people ) )
                {
                    foreach( $people AS $people_id=>$name )
                    {
                        ...
                        $mobile=$wpdb->get_var('SELECT mobile FROM '.$wpdb->prefix.'church_admin_people WHERE people_id="'.(int)$people_id.'" AND mobile!="" AND sms_send=1 ');
...
*****************************/
//Kiosk app
add_action('wp_ajax_nopriv_church_admin_kiosk_app', 'church_admin_kiosk_app_ajax');
add_action('wp_ajax_church_admin_kiosk_app', 'church_admin_kiosk_app_ajax');
function church_admin_kiosk_app_ajax(){
    global $wpdb;
 church_admin_debug($_REQUEST);
    ...
    require_once( plugin_dir_path( __FILE__ ) .'includes/kiosk-app.php');

    $method = !empty($_REQUEST['method']) ? church_admin_sanitize($_REQUEST['method']) : null;
    $token = !empty($_REQUEST['token']) ? church_admin_sanitize($_REQUEST['token']) : null;
    if(empty($method)){
        $output =  array('message'=>__('Missing method','church-admin'));
        echo json_encode($output);
        exit();
    }
    if(empty($token)){
        $output =  array('message'=>__('Missing token','church-admin'));
        echo json_encode($output);
        exit();
    }
    /***********
    ...
    switch($method){
        case 'get_form':
            $output = church_admin_kiosk_app_form();
            echo json_encode(array('form'=>$output));
            exit();
        break;
        case 'lock':
            $generated_token = get_option('church_admin_kiosk_token');
            if(!empty($generated_token) && $generated_token == $token ){
                $output = array('message'=>__('Success','church-admin'));
                $output['form'] = get_option('church_admin_kiosk_form');
            }
            else{
                $output = array('message'=>__('Token mismatch','church-admin'));
            }
        break;
        case 'register':
            church_admin_debug($_REQUEST);
            $result = church_admin_kiosk_process_register();
            switch($result)
            {
                case false:
                    $output =  array( 'message'=> __( 'Missing email address', 'church-admin'),'next'=>0 );
                break;
                case '1':
                    $output = array( 'message'=> __( 'Success', 'church-admin'),'content'=>'<p><button class="action button" data-action="back">'.__('Register another?','church-admin').'</button></p>', 'next' => 1  );
                break;
                case '2':
                    $output = array( 'message'=> __( 'Already registered', 'church-admin' ),'content'=>'<p><button class="action button" data-action="back">'.__('Register another?','church-admin').'</button></p>', 'next'=>2 ) ;
                break;
            }
        break;
        case 'event-save':
            $event_id = !empty($_POST['id']) ? (int)church_admin_sanitize($_POST['id']) : null;
            if(empty($event_id)){
                $output = array('error'=>esc_html(__('No event chosen','church-admin')));
            }
            else{
                $tickets = $wpdb->get_results('SELECT * FROM '.$wpdb->prefix.'church_admin_bookings WHERE event_id="'.esc_sql($event_id).'" ORDER BY last_name,first_name');
                if(empty($tickets)){
                    $output = array('error'=>esc_html(__('No tickets for that event','church-admin')));
                }
                else{
                    $out = '<h3>'.esc_html(__('Choose ticketsto check-in','church-admin')).'</h3>';
                    foreach($tickets AS $ticket){
                        $out.='<p><input type="checkbox" class="ticket" data-ticket="'.(int)$ticket->ticket_id.'">'.esc_html(church_admin_formatted_name($ticket)).'</p>';
                    }
                    $output = array('content'=>$out);
                }
        ...
        case 'event-choose':
            $events = $wpdb->get_results('SELECT * FROM '.$wpdb->prefix.'church_admin_events WHERE event_date>="'.wp_date('Y-m-d').'"' );
            if(!empty($events)){
                $out = '<h3>'.esc_html(__('Choose event to check-in','church-admin')).'</h3><p><select id="event_id">';
                foreach($events AS $event){
                    $out.='<option value="'.(int)$event->event_id.'">'.esc_attr($event->title).'</option>';
                }
                $out.='</select></p>';
                $out.='<p><button class="action button" data-action="event-save">'.__('Choose event','church-admin').'</button></p>';
            }
            $output = array('content'=>$out);
        break;
        case 'check-in':
            $data = !empty($_POST['data'])? church_admin_sanitize($_POST['data']):null;
            if(empty($data)){
                $output = array('error'=>esc_html(__('No data','church-admin')));

            }
            else{
                $splitData = explode("/",$data);
                $checkinResult =$wpdb->query('UPDATE '.$wpdb->prefix.'church_admin_bookings SET check_in=NOW() WHERE booking_ref="'.esc_sql($splitData[0]).'" AND CONCAT_WS(" ",first_name,last_name)="'.esc_sql($splitData[1]).'"');
                
                church_admin_debug($wpdb->last_query);
                church_admin_debug('result '.$churchinResult);
                if(!empty($checkinResult)){
                    $output=array('success'=>esc_html(sprintf(__('%1$s checked in','church-admin'),$splitData[1])));
                }else{
                    $output = array('error'=>esc_html(__('Invalid data')));
                }
    ...
    church_admin_debug(json_encode($output));
    echo json_encode($output);
    exit();
}
		...
		switch ( $_REQUEST['method'] )
		{
            ...
            case 'create-calendar-event-from-rota':
                ...
                if(empty($event)){
                    ...
                    $event =  $wpdb->get_row('SELECT * FROM '.$wpdb->prefix.'church_admin_services WHERE service_id="'.(int)$service_id.'"');
                    $event->title = $event->service_name;
                    $event->start_date = $start_date;
                    $event->start_time= $event->service_time;
                    $event->location = $event->address;
                    $event->event_link=null;
                    $event->link_title=null;
                    $event->cat_id=1;
                    $event->facilities_id=null;
                    $event->general_calendar=1;
                    $event->recurring = 's';
                    $event->how_many = 1;
                }
            ...
            case 'week-attendance':
                ...
                //church_admin_debugprint_r( $_POST,TRUE) );
                $data=$_POST['formdata'];
                $out='<h2>'.esc_html( __('Attendance entered','church-admin' ) ).'</h2>';
                foreach( $data AS $id=>$item)
                {
                    if(!empty( $item[3] )&& !empty( $item[4] ) &&$item[4]!="0000-00-00")
                    {
                        ...
                        $attendance_id=$wpdb->get_var('SELECT attendance_id FROM '.$wpdb->prefix.'church_admin_attendance WHERE date="'.$date.'" AND mtg_type="'.$type.'" AND service_id="'.$service_id.'"');
                        if(!empty( $attendance_id) )
                        {
                            $rowsAffected=$wpdb->query('UPDATE '.$wpdb->prefix.'church_admin_attendance SET `'.$column.'`="'.$number.'" WHERE attendance_id="'.(int)$attendance_id.'"');
                            
                        }
                        else
                        {
                            $rowsAffected=$wpdb->query('INSERT INTO '.$wpdb->prefix.'church_admin_attendance (`'.$column.'`,`mtg_type`,`service_id`,`date`)VALUES("'.$number.'","'.$type.'","'.$service_id.'","'.$date.'")');
                        }
			...
			case 'ministry-parents':
                check_admin_referer('ministry-parents','nonce');
				//church_admin_debugprint_r( $_POST,TRUE) );
				//sanitize
                $order=explode(",",sanitize_text_field(stripslashes($_POST['order'] )));
				//church_admin_debugprint_r( $order,TRUE) );
				$wpdb->query('UPDATE '.$wpdb->prefix.'church_admin_ministries SET parentID=NULL');
				for ( $x=0; $x<count( $order)-1; $x++ )
				{
					
					$sql='UPDATE '.$wpdb->prefix.'church_admin_ministries SET parentID="'.(int)substr( $order[$x],3).'" WHERE ID="'.(int)substr( $order[$x+1],3).'"';
					//church_admin_debug $sql);
					$wpdb->query( $sql);
				}
 ...
 * STRIPE
 *****************************/
add_action("wp_ajax_church_admin_stripe_payment_process", "church_admin_stripe_payment_process");
add_action("wp_ajax_nopriv_church_admin_stripe_payment_process", "church_admin_stripe_payment_process");

function church_admin_stripe_payment_process(){
    global $wpdb;
    //church_admin_debug("Payment process ajax");
    //church_admin_debug($_REQUEST);
    require_once (plugin_dir_path( __FILE__ ) .'/stripe/vendor/autoload.php');
    $premium = get_option('church_admin_payment_gateway');
    if(empty($premium)){exit();}

    $test_mode = '';
    $pos = stripos($premium['stripe_public_key'],'test');
    if(!empty($pos)){$test_mode =__('TEST','church-admin').' ';}
    ...
    try
    {
        $payment = $stripe->paymentIntents->retrieve(
            church_admin_sanitize($_REQUEST["payment_id"]),
            []
        );
        //church_admin_debug('PAYMENT STATUS: '.$payment->status);
        //church_admin_debug("RESULT");
        //church_admin_debug($payment);
        if(!empty($payment->status) && $payment->status == "succeeded")
        {
            //church_admin_debug('Succeeded so processing');
           if(!empty($_REQUEST['ID'])){
                $person = $wpdb->get_var('SELECT a.*,b.address FROM '.$wpdb->prefix.'church_admin_people a, '.$wpdb->prefix.'church_admin_household b WHERE a.household_id=b.household_id AND a.user_id="'.(int)church_admin_sanitize($_REQUEST['ID']).'"');
            }
            $sanitized_email=church_admin_sanitize($payment->charges->data[0]->billing_details['email']);
            $sanitized_name=church_admin_sanitize($payment->charges->data[0]->billing_details['name']);
            $sanitized_amount = church_admin_sanitize($payment->charges->data[0]->amount);
            $receipt_url = church_admin_sanitize($payment->charges->data[0]->receipt_url);
            $txn_id=church_admin_sanitize($payment->charges->data[0]->id);
            $fee = church_admin_sanitize($payment->charges->data[0]->application_fee_amount);
            $fund = !empty($_REQUEST['fund'])?church_admin_sanitize($_POST['fund']):__('General','church-admin');
            $gift_aid = !empty($_REQUEST['gift_aid'])?1:0;
            $what = !empty($_REQUEST['what'])?church_admin_sanitize($_REQUEST['what']):'giving';
        
            $address = null;
            //validate
            $funds=get_option('church_admin_giving_funds');
            if(!in_array($fund,$funds)){$fund=__('General','church-admin');}
            if(!empty($sanitized_email) && is_email($sanitized_email)){
                $email = $sanitized_email;
            }else{$email = null;}
            
            if(!empty($sanitized_amount) && is_numeric($sanitized_amount)){
                $amount = $sanitized_amount/100;
            }
            //process transaction into database

            switch($what){
                case 'giving':
                    //church_admin_debug('donation');
                    if(!empty($person)) {
                            //use DB name
                    ...
                    $giving_id=$wpdb->get_var('SELECT giving_id FROM '.$wpdb->prefix.'church_admin_giving WHERE txn_id="'.esc_sql($txn_id).'"');
                    //church_admin_debug($wpdb->last_query);
                    if(!empty( $giving_id) )
                    {
                    ...
                    $wpdb->query('INSERT INTO '.$wpdb->prefix.'church_admin_giving (txn_id,txn_type,txn_frequency,name,address,email,people_id,donation_date,gift_aid) VALUES ("'.esc_sql($txn_id).'","'.$test_mode.'Stripe","single","'.esc_sql( $name).'","'.esc_sql( $address).'","'.esc_sql($email).'","'.(int)$ID.'","'.wp_date('Y-m-d H:i:s').'","'.esc_sql($gift_aid).'")');
                    $giving_id=$wpdb->insert_id;
                    //church_admin_debug $wpdb->last_query);
                    //Insert into Giving Meta table
                    $wpdb->query('INSERT INTO '.$wpdb->prefix.'church_admin_giving_meta (gross_amount,paypal_fee,txn_id,fund,giving_id,txn_date) VALUES ("'.esc_sql($amount).'","'.esc_sql($fee).'","'.esc_sql($txn_id).'","'.esc_sql($test_mode.$fund ).'","'.(int)$giving_id.'","'.esc_sql(wp_date('Y-m-d H:i:s')).'")');
                    //church_admin_debug $wpdb->last_query);
                    $message = '<p>'.__('Thank you for your donation.','church-admin').'</p>';
                    $message .= '<p><a href="'.esc_url($receipt_url).'">'.__('Receipt','church-admin').'</a></p>';
                    church_admin_donation_receipt_email($giving_id,FALSE);
                break;
            ...
            //church_admin_debug('Not succeeded');
            $message =  esc_html( __('Transaction already processed','church-admin'));
        }
        ...
        header('Access-Control-Allow-Headers: Content-MD5, X-Alt-Referer');
        header('Access-Control-Allow-Credentials: true');
        echo json_encode(array('message'=>wp_kses_post($message) ) );
        //church_admin_debug("***Processed ****");
        //church_admin_debug($message);
        exit();
...
function church_admin_paypal_giving_ipn_callback() {
    ...
    if (strcmp ( $res, "VERIFIED") == 0) 
    {
        ...
        {
            $mc_gross1 = !empty($_POST['mc_gross1'])?sanitize_text_field(stripslashes($_POST['mc_gross1'])):null;
            $mc_fee = !empty($_POST['mc_fee'])?sanitize_text_field(stripslashes($_POST['mc_fee'])):null;
            $payment_amount = esc_sql( $mc_gross1-$mc_fee );
        }
        else
        {
            $mc_gross = !empty($_POST['mc_gross'])?sanitize_text_field(stripslashes($_POST['mc_gross'])):null;
            $mc_fee = !empty($_POST['mc_fee'])?sanitize_text_field(stripslashes($_POST['mc_fee'])):null;
            $payment_amount = esc_sql( $mc_gross-$mc_fee );
        }
        $fund=!empty($_POST['item_name'] )?urldecode(sanitize_text_field(stripslashes( $_POST['item_name'] ))): __('General','church-admin');;
       
        if(!empty( $_POST['custom'] ) ){$giftAid=1;}else{$giftAid=0;}
        
        $txn_id = sanitize_text_field(stripslashes( $_POST['txn_id'] ) );
        $continue=FALSE;
        switch( $_POST['txn_type'] )
        {
            case 'subscr_payment':
                ...
                $gross_amount=sanitize_text_field(stripslashes($_POST['mc_gross']));
                $paypal_fee=sanitize_text_field(stripslashes($_POST['mc_fee']));
                $continue=TRUE;
            break;
            case 'web_accept':  
                $txn_type=__('Paypal','church-admin');
        ...
        if( $continue)
        {   
            $payer_email =  sanitize_text_field(stripslashes($_POST['payer_email'] ));
            $people_id= (int)sanitize_text_field(stripslashes($_POST['custom']));
            if ( empty( $people_id) )
            {
                $person=$wpdb->get_row('SELECT * FROM '.$wpdb->prefix.'church_admin_people WHERE email="'.esc_sql($payer_email).'"LIMIT 1');
                if(!empty( $giftAid)&&!empty( $person) )
                {
                    $wpdb->query('UPDATE '.$wpdb->prefix.'church_admin_people SET gift_aid=1 WHERE people_id="'.(int)$person->people_id.'"');
                }
            ...
            {
                $name=esc_sql(sanitize_text_field( stripslashes($_POST['first_name'].' '.$_POST['last_name'] ) ));
            }
            else
            {
                $name='';
            ...
            {
                $address=implode(", ",array_filter(array(sanitize_text_field( stripslashes( $_POST['address_street']) ),sanitize_text_field(  stripslashes($_POST['address_city'] )),sanitize_text_field(  stripslashes($_POST['address_city'] )),sanitize_text_field(  stripslashes($_POST['address_state'] )),sanitize_text_field( stripslashes( $_POST['address_zip'] ) ))) );
            }else{$address='';}
            /*
            //Deprecated code
            $sql='SELECT giving_id FROM '.$wpdb->prefix.'church_admin_giving WHERE gross_amount="'.$gross_amount.'" AND paypal_fee="'.$paypal_fee.'" AND txn_id="'.$txn_id.'" AND payer_email="'.$payer_email.'" AND people_id="'.(int)$people_id.'"';
            //church_admin_debug $sql);
            $check=$wpdb->get_var( $sql);

            if ( empty( $check) )
            {
                $wpdb->query('INSERT INTO '.$wpdb->prefix.'church_admin_giving (gross_amount,paypal_fee,gift_aid,txn_id,txn_type,txn_frequency,email,people_id,donation_date,fund,service_id,name,address) VALUES ("'.$gross_amount.'","'.$paypal_fee.'","'.$giftAid.'","'.$txn_id.'","PayPal","'.$txn_frequency.'","'.$payer_email.'","'.$people_id.'","'.date('Y-m-d H:i:s').'","'.esc_sql(sanitize_text_field( $_POST['item_name'] ) ).'","0","'.$name.'","'.$address.'")');
                //church_admin_debug $wpdb->last_query);
            }
            */
            /***************************************************
             ...
             * Insert into Giving table
             ***************************/
            $givng_id=$wpdb->get_var('SELECT giving_id FROM '.$wpdb->prefix.'church_admin_giving WHERE txn_id="'.esc_sql($txn_id).'"');
            $wpdb->query('INSERT INTO '.$wpdb->prefix.'church_admin_giving (txn_id,txn_type,txn_frequency,name,address,email,people_id,donation_date,gift_aid) VALUES ("'.esc_sql($txn_id).'","PayPal","'.esc_sql($txn_frequency).'","'.esc_sql( $name).'","'.esc_sql( $address).'","'.esc_sql($payer_email).'","'.(int)$people_id.'","'.date('Y-m-d H:i:s').'","'.esc_sql($giftAid).'")');
            $giving_id=$wpdb->insert_id;
            //church_admin_debug $wpdb->last_query);
            //Insert into Giving Meta table
            $wpdb->query('INSERT INTO '.$wpdb->prefix.'church_admin_giving_meta (gross_amount,paypal_fee,txn_id,fund,giving_id) VALUES ("'.esc_sql($gross_amount).'","'.esc_sql($paypal_fee).'","'.esc_sql($txn_id).'","'.esc_sql(sanitize_text_field( $_POST['item_name'] ) ).'","'.(int)$giving_id.'")');
            //church_admin_debug $wpdb->last_query);
            church_admin_donation_receipt_email($giving_id,FALSE);
        }
...
function church_admin_paypal_ipn_callback()
{
    ...
    if (strcmp ( $res, "VERIFIED") == 0) 
    {
        ...
        if(!empty( $_POST['mc_gross1'] ) )
        {
            $payment_amount = sanitize_text_field(stripslashes($_POST['mc_gross1'] ));
        }
        else
        {
            $payment_amount = sanitize_text_field(stripslashes($_POST['mc_gross']));
        }
        
        $txn_id =  sanitize_text_field(stripslashes($_POST['txn_id'] ));
        $payer_email = sanitize_text_field(stripslashes($_POST['payer_email'] ));
        $booking_ref= sanitize_text_field(stripslashes($_POST['custom'] ));
        $event_id=$wpdb->get_var('SELECT event_id FROM '.$wpdb->prefix.'church_admin_bookings WHERE booking_ref="'.esc_sql( $booking_ref).'"');
        $sql='SELECT payment_id FROM '.$wpdb->prefix.'church_admin_event_payments WHERE amount="'.esc_sql( $payment_amount).'" AND txn_id="'.esc_sql( $txn_id ).'" AND payer_email="'.esc_sql( $payer_email ).'" AND event_id="'.(int)$event_id.'" AND booking_ref="'.esc_sql( $booking_ref ).'"';
        //church_admin_debug $sql);
        $check=$wpdb->get_var( $sql);
        
        if ( empty( $check) )
        {
            $wpdb->query('INSERT INTO '.$wpdb->prefix.'church_admin_event_payments (amount,txn_id,payer_email,booking_ref,payment_date,event_id) VALUES ("'.esc_sql( $payment_amount).'","'.esc_sql( $txn_id ).'","'.esc_sql( $payer_email ).'","'.esc_sql( $booking_ref ).'","'.esc_sql( date('Y-m-d H:i:s')).'","'.(int)$event_id.'")');
            //church_admin_debug $wpdb->last_query);
        }
    } else if (strcmp ( $res, "INVALID") == 0) 
    {
...
function church_admin_test_function(){
    echo'<pre>';
    $days = church_admin_get_days(2024,07,1);
    echo'<pre>';
    print_r($days);
    echo'</pre>';
}