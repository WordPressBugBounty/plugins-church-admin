...
function church_admin_block_init() {
	...
	*
	*****************/
	if ( ! WP_Block_Type_Registry::get_instance()->is_registered( 'church-admin/address-list' ) ) {
	...
	*
	***********************************************************************************************/
	if ( ! WP_Block_Type_Registry::get_instance()->is_registered( 'church-admin/calendar' ) ) {
	...
	*
	***********************************************************************************************/
	if ( ! WP_Block_Type_Registry::get_instance()->is_registered( 'church-admin/calendar-list' ) ) {
	...
	*
	***********************************************************************************************/
	if ( ! WP_Block_Type_Registry::get_instance()->is_registered( 'church-admin/register' ) ) {
    ...
    *
    ****************************/
	if ( ! WP_Block_Type_Registry::get_instance()->is_registered( 'church-admin/basic-register' ) ) {
	...
	*
	***********************************************************************************************/
	if ( ! WP_Block_Type_Registry::get_instance()->is_registered( 'church-admin/sermon-podcast' ) ) {
	...
	if ( ! WP_Block_Type_Registry::get_instance()->is_registered( 'church-admin/sermons' ) ) {
	...
	***********************************************************************************************/
	...
	if ( ! WP_Block_Type_Registry::get_instance()->is_registered( 'church-admin/recent' ) ) {
	...
	*
	***********************************************************************************************/
if ( ! WP_Block_Type_Registry::get_instance()->is_registered( 'church-admin/sermon-series' ) ) {
